...
%
% BEFORE SUBMITTING:
%   1. Verify the \cite{cidre} arXiv id (2509.15782) against the real paper.
%      This is the last unchecked fact in the paper.
%   2. Optionally add a personal contact address (see the author block).
