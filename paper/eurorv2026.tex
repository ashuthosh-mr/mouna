...
break-even by construction; and up to 8.4\% of all cycles are lost purely to
...
between 0.46 and 0.83. A custom-instruction search that ranks candidates by how
much \emph{arithmetic} they remove is therefore optimising the wrong term.
