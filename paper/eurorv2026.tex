...
%
% BEFORE SUBMITTING:
%   1. Confirm the city in the affiliation block below (inferred, not checked).
%   2. Verify the \cite{cidre} arXiv id (2509.15782) against the real paper.
% Affiliation and the PARISCV v1 citation are both settled.
%=============================================================================
...
any of its recommendations are trusted. The work continues
PARISCV~\cite{pariscv1}, a profiler for application-specific RISC-V
optimisation. What is new here is that the estimate comes from a cycle model
checked against the target core's own RTL, so a candidate can be scored before
any hardware for it exists. This paper reports that validation and what it then
revealed.
